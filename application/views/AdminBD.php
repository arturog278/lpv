        ...
        <div id="collapseOne" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <table class="table">
                                <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-plus text-primary"></span><a href="<?php redirect(base_url().'AdminBD/Alumnos/1')?>">Altas</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-list-alt text-success"></span><a href="<?php redirect(base_url().'AdminBD/Alumnos/4')?>">Consultas</a>
                                    </td>
                                </tr>
                            </table>
                        </div>
